...
import com.neophron.rajuuu.gasvally.util.IabBroadcastReceiver;
import com.neophron.rajuuu.gasvally.util.IabHelper;
import com.neophron.rajuuu.gasvally.util.IabResult;
import com.neophron.rajuuu.gasvally.util.Inventory;
import com.neophron.rajuuu.gasvally.util.NetworkHandler;
import com.neophron.rajuuu.gasvally.util.PermissionUtil;
import com.neophron.rajuuu.gasvally.util.Pref;
import com.neophron.rajuuu.gasvally.util.ProgressDialogHelper;
import com.neophron.rajuuu.gasvally.util.Purchase;
import com.neophron.rajuuu.gasvally.util.UrlHander;
import com.google.android.gms.ads.AdView;

import java.util.ArrayList;
import java.util.List;

public class MainActivity extends AppCompatActivity implements DownloadListener, IabBroadcastReceiver.IabBroadcastListener {
    ...
    private void checkURL(Intent intent) {
        ...
        if (TextUtils.isEmpty(target_url)) {
            ...
            target_url = "http://192.168.43.220/MyOwnProjects/Checkmate/";
            target_url_prefix = Uri.parse(target_url).getHost();
